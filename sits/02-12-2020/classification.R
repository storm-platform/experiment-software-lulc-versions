...
samples_mt_4bands <- sits_select(samples_mt_4bands, bands = c("ndvi", "evi"))
rfor_model <- sits_train(samples_mt_4bands, ml_method = sits_rfor(num_trees = 300))
...
raster_cube <- sits_cube(type = "RASTER", name = "Sinop", 
